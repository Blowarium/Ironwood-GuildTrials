    ...
    <div className="flex w-full flex-col gap-2 sm:ml-auto sm:w-auto sm:flex-row sm:flex-wrap sm:items-center">
      ...
      {staffLocked && (
        <button
          ...
          className="rounded-md border border-amber-500/40 bg-amber-950/40 px-3 py-2.5 text-xs font-semibold text-amber-200 hover:bg-amber-900/40 sm:py-2"
        >
      ...
      {staffUnlocked && isStaffRole(dbRole) && (
        <button
          ...
          className="rounded-md border border-slate-600 px-2 py-2.5 text-xs text-slate-400 hover:text-slate-200 sm:py-2"
      ...
      <button
        ...
        className="rounded-md bg-sky-600 px-3 py-2.5 text-xs font-semibold text-white hover:bg-sky-500 sm:py-2"
      >
        My profile
      </button>
      <button
